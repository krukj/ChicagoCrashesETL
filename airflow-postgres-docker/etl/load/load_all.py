...
def main():
    ...
    paths = {
        'dim_date': os.path.join(base_dir, "data", "tmp", "transformed", "dim_date.pkl"),
        'dim_location': os.path.join(base_dir, "data", "tmp", "transformed", "dim_location.pkl"),
        'dim_vehicle': os.path.join(base_dir, "data", "tmp", "transformed", "dim_vehicle.pkl"),
        'dim_person': os.path.join(base_dir, "data", "tmp", "transformed", "dim_people.pkl"),
        'dim_crash_info': os.path.join(base_dir, "data", "tmp", "transformed", "dim_crash_info.pkl"),
        'fact_weather': os.path.join(base_dir, "data", "tmp", "transformed", "fact_weather.pkl"),
        'fact_crash': os.path.join(base_dir, "data", "tmp", "transformed", "fact_crash.pkl"),
    }
