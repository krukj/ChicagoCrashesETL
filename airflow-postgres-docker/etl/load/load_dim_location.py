...
def load_dim_location(filepath_in) -> None:
    try:
        ...
        cursor.execute("INSERT INTO core.dim_location SELECT * FROM staging.dim_location;")
        conn.commit()
...
def main():
    ...
    filepath_in = os.path.join(base_dir, "data", "tmp", "transformed", "dim_location.pkl")
